...
namespace LinqConsoleApp
{
    public class LinqSamples
    {
        ...
        public void Przyklad3()
        {
            ...
            var resL = Emps.Max(emp => emp.Salary);
        ...
        {
            var resL = Emps.GroupBy(emp => emp.Job)
                .Select(group => new
                {

                    Praca = group.Key,
                    LiczbaPrac = group.Count()
        ...
        {
            var resL = Emps.Where(emp => emp.Job == "Frontend programmer")
        ...
        public void Przyklad11()
        {
            ...
            var res = Emps.Select(emp => emp.Salary)
                .Aggregate(0, (max, next) => next > max ? next : max);
        }
